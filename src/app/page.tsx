      ...
      bulletPoints={[
        {
          ...
          description: "Massive range of hard-to-find antiques.",
        },
        {
          title: "Curated Pieces",
          description: "Unique furniture and high-end finds.",
        },
        {
          title: "Family Owned",
          description: "Personal service from our family to yours.",
        },
      ]}
      ...
      products={[
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/antique-compass-close-up_93675-130025.jpg",
        },
        {
          id: "p2",
          name: "Unique Furniture",
          price: "Contact for pricing",
          imageSrc: "http://img.b2bpic.net/free-photo/interior-design-with-vintage-bathtub_23-2148291618.jpg",
        },
        {
          id: "p3",
          name: "Fun Finds",
          price: "From $25",
          imageSrc: "http://img.b2bpic.net/free-photo/scene-with-miscellaneous-items-being-sold-yard-sale-bargains_23-2151216804.jpg",
        },
      ]}
